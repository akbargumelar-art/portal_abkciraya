...
import { SalesPlanPerdanaData, SalesPlanProductData, SalesPlanPeriodData } from '../types';
...
export const salesPlanPerdanaData: SalesPlanPerdanaData[] = outletData.map(outlet => {
    const simpatiData = generateProductData();
    const byuData = generateProductData();

    const totalPerdanaData: SalesPlanProductData = {
        W1: {
